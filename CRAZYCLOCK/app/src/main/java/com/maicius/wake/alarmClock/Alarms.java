...
public class Alarms {
    ...
    public static final String ALARM_ALERT_ACTION = "com.maicius.wake.alarmClock.ALARM_ALERT";
    ...
    public static final String ALARM_DONE_ACTION = "com.maicius.wake.alarmClock.ALARM_DONE";
    ...
    public static final String ALARM_SNOOZE_ACTION = "com.maicius.wake.alarmClock.ALARM_SNOOZE";

    // AlarmAlertFullScreen listens for this broadcast intent, so that other applications
    // can dismiss the alarm (after ALARM_ALERT_ACTION and before ALARM_DONE_ACTION).
    public static final String ALARM_DISMISS_ACTION = "com.maicius.wake.alarmClock.ALARM_DISMISS";
    ...
    private static void enableAlert(Context context, final Alarm alarm,
        ...
        if (true) {
            Log.v("maicius", "** setAlert id " + alarm.id + " atTime " + atTimeInMillis);
        }
